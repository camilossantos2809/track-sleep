...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            append("\t${convertLongToDateString(it.startMilli)}<br>")
            if (it.endTimeMilli != it.startMilli) {
                ...
                // Hours
                append("\t ${it.endTimeMilli.minus(it.startMilli) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTimeMilli.minus(it.startMilli) / 1000 / 60}:")
                // Seconds
                append("${it.endTimeMilli.minus(it.startMilli) / 1000}<br><br>")
            }
        }
    }
